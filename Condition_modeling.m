...
subplot(2,3,5); plot(mean_A,Beta2_A,'.k'); xlabel('mean(condition 1)'); ylabel('beta_A_2');
subplot(2,3,6); plot(mean_B,Beta2_A,'.k'); xlabel('mean(condition 2)'); ylabel('beta_A_2');
